...
try {
	...
	String Query1 = "SELECT id, filename FROM review WHERE num=?";
	...
	String oldfilename = rs.getString(2);
		...
		String Query2 = "UPDATE review SET title=?, text=?, filename=? WHERE num=?";
		...
		pstmt.close();
		conn.close();
		String retUrl = "ReviewContent.jsp?rno=" + rno + "&column=" + column + "&key=" + encoded_key;
