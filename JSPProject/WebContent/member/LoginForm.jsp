...
<body>
	...
	<table align=center width=620 height=40 border=0 cellspacing=1
	...
	<FORM NAME="Login" method=post
		action="../member/LoginProc.jsp?CorrentPage=<%=m_cp%>&column=<%=m_column%>&key=<%=m_encoded_key%>">

		<table align=center width=400 border=1 cellspacing=0 cellpadding=2
			align="left">
			<tr align=center>
				<td width=120 align=center><b>아이디</b></td>
				<td width=200><input type=text name="id" size=20 maxlength=10
					style="ime-mode: inactive">&nbsp;&nbsp;</td>
			</tr>
			<tr align=center>
				<td width=120 align=center><b>패스워드</b></td>
				<td width=200><input type=password name="pw" size=21.5
					maxlength=10></td>
			</tr>
		</table>
		<br>
		<table width=620 height=50 border=0 cellspacing=1 cellpadding=1
			...
			<tr align=center>
				<td><input type="submit" value="확인"
					...
					OnClick="window.location='BeMember.jsp'">&nbsp;&nbsp; <input
					type="button" value="취소"
					OnClick="location.replace('../main/Main.jsp')"></td>
			</tr>
		</table>
	</FORM>
</body>
