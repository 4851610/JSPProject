	...
	<FORM NAME="BeMember" method=post
		...
		<table align=center width=630 border=1 cellspacing=0 cellpadding=2>
			<tr>
				...
				<td width=500><input type=text name="name" size=20 maxlength=20
					style="ime-mode: active"></td>
			</tr>

			<tr>
				<td width=120 align=center><b>아이디</b></td>
				<td width=500><input type=text name="id" size=20 maxlength=10>
			...
			<tr>
				...
				<td width=500><input type=text name="mail" size=60 maxlength=90
					style="ime-mode: inactive"></td>
			</tr>
		</table>
	</FORM>

	<table width=620 hegight=50 border=0 cellspacing=1 cellpadding=1
		align=center>
		<tr align=center>
			<td><input type="button" value="확인"
				OnClick="javascript:CheckMemberForm(BeMember)">&nbsp;&nbsp;
