...
<table width=600 height=40 border=0 cellspacing=1 cellpadding=1 align=center>
	<tr bgcolor=#D1B2FF>
		<td align=center><font size=4><b>★ 공지사항 작성 ★</b></font></td>
		</tr>
</table>

<form name="NoticeWrite" method=post action="../notice/NoticeWriteProc.jsp?column=<%=column%>&key=<%=encoded_key%>">
...
<tr align=right>
	<td >
	<input type = "button" value="글목록" OnClick="javascript:location.replace('NoticeList.jsp?column=<%=column%>&key=<%=encoded_key%>')"style=cursor:hand>&nbsp;&nbsp;
	<input type = "button" value="확인" OnClick="javascipt:CheckForm(NoticeWrite)" >&nbsp;&nbsp;
	<input type = "button" value="취소" OnClick="javascipt:location.replace('NoticeList.jsp')" style=corsor:hand>
	</td>
	</tr>
</table>
</body>
...
%>
<center>권한이 없습니다. &nbsp;&nbsp;<input type = "button" value = "확인" OnClick="javascript:location.href=('../main/Main.jsp')"></center>
<%
}
%>